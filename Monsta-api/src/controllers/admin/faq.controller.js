...
exports.create = async (request, response) => {
    ...
    try {
        ...
        const insertData = new faqModal(data);
...
exports.view = async (request, response) => {
    ...
    var totalRecords = await faqModal.find(filter).countDocuments();
...
exports.details = async (request, response) => {
    ...
    // })
    try {
        await faqModal.findById(request.body.id)
            .then((result) => {
                if (result) {
                    const output = {
                        _status: true,
