const testimonailModal = require('../../models/Testimonial');
...
exports.create = async (request, response) => {
    ...
    try {
        ...
        const insertData = new testimonailModal(data);
...
exports.view = async (request, response) => {
    ...
    var totalRecords = await testimonailModal.find(filter).countDocuments();
    ...
    await testimonailModal.find(filter)
...
exports.details = async (request, response) => {
    ...
    // })
    try {
        await testimonailModal.findById(request.body.id)
            .then((result) => {
                if (result) {
                    const output = {
                        _status: true,
...
exports.update = async (request, response) => {
    ...
    try {
        ...
        await testimonailModal.updateOne({
...
exports.changeStatus = async (request, response) => {
    ...
    try {
        ...
        await testimonailModal.updateMany({
            _id: {
                $in: request.body.id
            }
        }, [{
