...
exports.create = async (request, response) => {
    ...
    if(request.file){
        ...
        const insertData = new subcategoriesModal(data);
...
exports.view = async (request, response) => {
    ...
    var totalRecords=await subcategoriesModal.find(filter).countDocuments();
    ...
    await subcategoriesModal.find(filter)
...
exports.details = async (request, response) => {
    ...
    // })
    try{
    await subcategoriesModal.findById(request.body.id)
        .then((result) => {
            if (result) {
                const output = {
                    _status: true,
...
exports.update = async (request, response) => {
    ...
    await subcategoriesModal.updateOne({
...
exports.changeStatus = async (request, response) => {
       ...
       await subcategoriesModal.updateMany({
           _id: {
               $in: request.body.id
           }
       },[ {
