...
exports.create = async (request, response) => {
    ...
    try {
        ...
        const insertData = new sliderModal(data);
...
exports.view = async (request, response) => {
    ...
    var totalRecords = await sliderModal.find(filter).countDocuments();
...
exports.details = async (request, response) => {
    ...
    // })
    try {
        await sliderModal.findById(request.body.id)
            .then((result) => {
                if (result) {
                    const output = {
                        _status: true,
