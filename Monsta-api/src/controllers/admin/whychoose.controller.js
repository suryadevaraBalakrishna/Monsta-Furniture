const whychooseModal = require('../../models/WhyChoose');
...
exports.create = async (request, response) => {
    ...
    try {
        ...
        const insertData = new whychooseModal(data);
...
exports.view = async (request, response) => {
    ...
    var totalRecords = await whychooseModal.find(filter).countDocuments();
    ...
    await whychooseModal.find(filter)
        ...
        .then((result) => {
            if (result.length > 0) {
                const output = {
                    ...
                    _image_path: process.env.choose_image,
                    _data: result
                }
...
exports.details = async (request, response) => {
    ...
    // })
    try {
        await whychooseModal.findById(request.body.id)
            .then((result) => {
                if (result) {
                    const output = {
                        _status: true,
...
exports.update = async (request, response) => {
    ...
    try {
        ...
        await whychooseModal.updateOne({
...
exports.changeStatus = async (request, response) => {
    ...
    try {
        ...
        await whychooseModal.updateMany({
            _id: {
                $in: request.body.id
            }
        }, [{
