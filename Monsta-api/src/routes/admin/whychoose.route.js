...
const { create, view, update, details, changeStatus, destroy } = require('../../controllers/admin/whychoose.controller');
const router = express.Router();
const multer = require('multer')
const uploads = multer({ dest: 'uploads/choose' })
...
module.exports = server => {
    ...
    server.use('/api/admin/whychoose', router);
}